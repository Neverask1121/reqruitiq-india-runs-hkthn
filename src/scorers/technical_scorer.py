...
#         else:
#             required_score(
#                 len(matched_required)/len(matched_skills)*30
...
#         else:
#             preferred_score(
#                 len(matched_preferred)/len(preferred_skills)*5
...
#         "matched_Preferred":sorted(mateched_preferred),
#         "missing_required":sorted(required_Skills-match_required),
#     }
